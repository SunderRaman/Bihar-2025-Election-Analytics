...
AC_NO, AC_NAME, DISTRICT,Candidate, Party, Votes, Margin, Status,GENERAL_SC reservation tag, Vote_Percent for winners
Wasted_Votes, Effective_Votes, Votes_per_Seat,Margin bucket flags: <500, 0.5-2K, 2_10K, etc.
...
cd Bihar-2025-Election-Analytics
b) pip install -r requirements.txt
c) jupyter notebook notebooks/Bihar_2025_Election_Analytics.ipynb
**5. Data Sources**
